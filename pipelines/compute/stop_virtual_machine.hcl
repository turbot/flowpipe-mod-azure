pipeline "stop_virtual_machine" {
  ...
  step "container" "stop_virtual_machine" {
  ...
  output "vm_out" {
    ...
    value       = step.container.stop_virtual_machine.stdout
  }

  output "vm_err" {
    description = "VM error."
    value       = step.container.stop_virtual_machine.stderr
  }
}
